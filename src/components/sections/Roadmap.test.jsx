...
it('renders the sub-line containing career name and semester count', () => {
  render(<Roadmap />);
  ...
  expect(screen.getByText(new RegExp(`${roadmap.totalSemesters} semestres`))).toBeInTheDocument();
});
